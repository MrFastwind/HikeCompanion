...
class PrivateFragment : Fragment(), OnItemListener, MenuProvider {
    private lateinit var adapter: CourseAdapter
    private val listViewModel: PrivateListViewModel by activityViewModels()
    ...
    companion object {
        private const val LOG_TAG = "PrivateFragment"
    }
